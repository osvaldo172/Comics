...
START TRANSACTION;
USE `comics`;
INSERT INTO `comics`.`comics` (`idcomic`, `nombre`, `descripcion`, `fecha`, `cantidad`, `precio`, `imagen`, `editorial_ideditorial`, `edicion_idedicion`) VALUES (25857301210, 'Avengers vs x-men Round 7', 'Esta es la prueba del comic me da weba meter la descripcion verdadera', '2012-09-22', 3, 29.90, 'a_vs_x__r_7.jpg', 1, 1);
INSERT INTO `comics`.`comics` (`idcomic`, `nombre`, `descripcion`, `fecha`, `cantidad`, `precio`, `imagen`, `editorial_ideditorial`, `edicion_idedicion`) VALUES (70719405, 'Batman no 5', 'Esta es la prueba de la descripcion de batman, incisto me da weba poner la descripcion jejejeje', '14/Nov/2012', 1, 30, 'batman_5.jpg', 2, 2);
INSERT INTO `comics`.`comics` (`idcomic`, `nombre`, `descripcion`, `fecha`, `cantidad`, `precio`, `imagen`, `editorial_ideditorial`, `edicion_idedicion`) VALUES (0233, 'Avengers vs x-men Round 3', 'Esta es la prueba para ver la linea de separacion entre comics, me da weba meter la descripcion real jejejeje', '2012-08-25', 1, 21, 'a_vs_x_r_3.jpg', 1, 1);
INSERT INTO `comics`.`comics` (`idcomic`, `nombre`, `descripcion`, `fecha`, `cantidad`, `precio`, `imagen`, `editorial_ideditorial`, `edicion_idedicion`) VALUES (01201, 'Superman no 1', 'Otra vez tengo weba', '12/Jul/2012', 1, 35, 'superman_1.jpg', 2, 2);
INSERT INTO `comics`.`comics` (`idcomic`, `nombre`, `descripcion`, `fecha`, `cantidad`, `precio`, `imagen`, `editorial_ideditorial`, `edicion_idedicion`) VALUES (40769825, 'The invencible iron man', 'La larga caida parte 3', '26/11/2012', 1, 23, 'i_m_p3.jpg', 1, 2);
