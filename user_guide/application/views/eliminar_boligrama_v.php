...
<!--         <script src="<?=base_url(); ?>static/js/boligrama.js"></script> -->    </head>
	<body>
		<div class="row">
			<div class="twelve columns">
				...
				<fieldset >
					<form class="custom" action="" method="post">
						<div class="row">
							<br><label>¿Seguro que deseas eliminar tu boligrama?</label><hr>
						<input type="submit" id="eliminarBtn" name="eliminarBtn" class="button offset-by-two" value="Eliminar" />
					</form>
				</fieldset>
